...
public class CricketEventApple : MonoBehaviour
{
    public static CricketEventApple instance;
    Tween grillo;
    ...
    public void spawnCricket()
    {
        ...
        grillo = transform.DOLocalJump(new Vector3(-Screen.currentResolution.width / 2 - 1000, transform.localPosition.y, 1), 500f, 12, 6f).SetDelay(3f).OnComplete(() =>
        {
